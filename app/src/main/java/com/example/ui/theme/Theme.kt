...
private val DarkColorScheme =
  darkColorScheme(
    ...
    tertiaryContainer = WarmClayTertiaryContainerDark,
    onTertiaryContainer = WarmClayOnTertiaryContainerDark,
...
private val LightColorScheme =
  lightColorScheme(
    ...
    tertiary = WarmClayTertiary,
    onTertiary = WarmClayOnTertiary,
    tertiaryContainer = WarmClayTertiaryContainer,
    onTertiaryContainer = WarmClayOnTertiaryContainer,
...
fun MyApplicationTheme(
  ...
  // Set to false by default to ensure the wellness theme is visible
